...
export default function RaffleStage({
  ...
  const eligibleAttendees = attendees.filter(
    (a) => !a.hasWon && !a.excludedFromRaffle,
  );
      ...
      <main className="relative z-10 h-full overflow-hidden">
        <section className="w-full h-full relative">
          <div className="relative w-full h-full bg-transparent">
            <div className="absolute inset-0 translate-y-[10%] flex flex-col items-center justify-center z-10">
                  ...
                  currentWinner && (
                    ...
                    >
                      <WinnerReveal
                        ...
                        prizeName={
                          currentWinner.prizeName || selectedPrize?.name || ""
                        }
                      />
                    </motion.div>
                  )}
                    ...
                    {prizes.map((p) => (
                      ...
                      >
                        <div className="flex items-center justify-between w-full gap-4 min-w-[240px]">
                          ...
                          <span
                            className={`text-sm ${p.quantityRemaining <= 0 ? "text-red-400" : "text-emerald-400"}`}
                          >
              ...
              >
                ...
                {state === "spinning" && (
                  <Button
                    disabled
                    size="lg"
                    className="h-14 w-60 rounded-full bg-slate-800/90 text-xl backdrop-blur-md border border-slate-700"
                  >
